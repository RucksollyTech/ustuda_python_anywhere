...
class Logged_In_User_Jwt_Rec(models.Model):
    user = models.ForeignKey(User, related_name='logged_in_jwt_user',on_delete=models.CASCADE,null=True,blank=True)
...
class Courses(models.Model):
    ...
    schools = models.ForeignKey(Schools,on_delete=models.SET_NULL,null=True,blank=True)
    tutorial = models.ForeignKey(Tutorial,on_delete=models.SET_NULL,null=True,blank=True,related_name="tutorial_singles")
